...
class Linear:
    ...
    def __init__(self, in_layer, num_out_features):
        ...
        # self.W = np.random.randn(self.num_in_features, num_out_features) * 0.01 # TODO: Sid to verify 
...
class Bias:
    ...
    def __init__(self, in_layer):
        ...
        # TODO: Declare the weight matrix. Be careful how you initialize the matrix.
        self.W = np.zeros(shape=(1, self.num_in_features)) # TODO: Sid to verify
